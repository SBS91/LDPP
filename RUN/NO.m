...
for video_type = 1:2
    ...
    for video_index = 1:9
        ...
        load(FOV_Data_name);
            ...
            %view_port GT load
            tile = squeeze(tile_Index((persion-1)*9+video_index,5:164,:,:));
        ...
        tile_set_name = strcat("C:\Users\SBS_BTL\OneDrive - 서울과학기술대학교\23-1\LYA\Result\Updated_tile\",video_count_name,"_NOMAL_tile_set");
...
save("C:\Users\SBS_BTL\OneDrive - 서울과학기술대학교\23-1\LYA\Result\fov_level\UQ_NOMAL","Summary_UQ");
