...
for video_type = 1:2
    ...
    for video_index = 1:9
        ...
        tile_set_name = strcat(video_count_name,"_0831NEW_LR_tile");
        psnr_set_name = strcat(video_count_name,"_0831NEW_LR_psnr");
...
% save("C:\Users\SBS_BTL\OneDrive - 서울과학기술대학교\23-1\LYA\Result\fov_level\UQ_LR","Summary_UQ");
