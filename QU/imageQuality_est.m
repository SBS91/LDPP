...
for i = 0:N-1
    ...
    UQn_opt(t,Uc,i+1) = E_tile(t-10,Uc,lat,lon)*Q_opt(t,Uc,i+1);
    UQn_Level_opt(t,Uc,i+1) = E_tile(t-10,Uc,lat,lon)*Xopt(t,Uc,i+1);
end
...
%Making U
U_before(t,Uc) = UQ_opt(t+Uc-1) - lamda*UV_opt;